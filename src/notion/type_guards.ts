import { Bookmark, Breadcrumb, BulletedListItem, Callout, CheckBoxProperty, ChildDatabase, ChildPage, Code, ColumnList, CreatedByProperty, CreatedTimeProperty, DateProperty, Divider, EmailProperty, Embed, Emoji, Equation, File, FilesProperty, FormulaProperty, Heading1, Heading2, Heading3, Image, LastEditedByProperty, LastEditedTimeProperty, LinkPreview, MultiSelectProperty, NumberProperty, NumberedListItem, PDF, Paragraph, PeopleProperty, PhoneNumberProperty, Quote, RelationProperty, RichTextProperty, RollupProperty, SelectProperty, StatusProperty, SyncedBlock, Table, TableOfContents, TableRow, TitleProperty, ToDo, Toggle, UrlProperty, Video } from "./types";
...
export function isBulletedListItemBlock(block: unknown): block is BulletedListItem {
...
export function isNumberedListItemBlock(block: unknown): block is NumberedListItem {
...
export function isTableOfContentsBlock(block: unknown): block is TableOfContents {
...
export function isCheckBoxProperty(property: unknown): property is CheckBoxProperty {
  return (property as CheckBoxProperty).type === "checkbox";
}

// Type Guards for CreatedByProperty
export function isCreatedByProperty(property: unknown): property is CreatedByProperty {
  return (property as CreatedByProperty).type === "created_by";
}

// Type Guards for CreatedTimeProperty
export function isCreatedTimeProperty(property: unknown): property is CreatedTimeProperty {
...
export function isFormulaProperty(property: unknown): property is FormulaProperty {
  return (property as FormulaProperty).type === "formula";
}

// Type Guards for LastEditedByProperty
export function isLastEditedByProperty(property: unknown): property is LastEditedByProperty {
  return (property as LastEditedByProperty).type === "last_edited_by";
}

// Type Guards for LastEditedTimeProperty
export function isLastEditedTimeProperty(property: unknown): property is LastEditedTimeProperty {
  return (property as LastEditedTimeProperty).type === "last_edited_time";
}

// Type Guards for MultiSelectProperty
export function isMultiSelectProperty(property: unknown): property is MultiSelectProperty {
  return (property as MultiSelectProperty).type === "multi_select";
}

// Type Guards for NumberProperty
export function isNumberProperty(property: unknown): property is NumberProperty {
  return (property as NumberProperty).type === "number";
}

// Type Guards for PeopleProperty
export function isPeopleProperty(property: unknown): property is PeopleProperty {
  return (property as PeopleProperty).type === "people";
}

// Type Guards for PhoneNumberProperty
export function isPhoneNumberProperty(property: unknown): property is PhoneNumberProperty {
  return (property as PhoneNumberProperty).type === "phone_number";
}

// Type Guards for RelationProperty
export function isRelationProperty(property: unknown): property is RelationProperty {
  return (property as RelationProperty).type === "relation";
}

// Type Guards for RichTextProperty
export function isRichTextProperty(property: unknown): property is RichTextProperty {
  return (property as RichTextProperty).type === "rich_text";
}

// Type Guards for RollupProperty
export function isRollupProperty(property: unknown): property is RollupProperty {
...
export function isSelectProperty(property: unknown): property is SelectProperty {
  return (property as SelectProperty).type === "select";
}

// Type Guards for StatusProperty
export function isStatusProperty(property: unknown): property is StatusProperty {
